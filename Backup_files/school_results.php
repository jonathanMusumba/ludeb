...
if (isset($_POST['download_sheet'])) {
    ...
    $pdf->Cell(0, 10, 'MOCK EXAMINATIONS - ' . ($current_year ?? 'Current Year'), 0, 1, 'L');
    $pdf->Cell(0, 10, 'SCHOOL: ' . ($selected_school_name ?? 'Unknown School'), 0, 1, 'L');
...
<div class="container mt-5">
    ...
    <?php if (!empty($candidates)): ?>
        ...
        <form action="district_results.php" method="post">
        <button type="submit" name="download_sheet">Download District Results</button>
        </form>
