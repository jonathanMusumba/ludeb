...
BEGIN
    ...
    -- Insert into candidate_results if all four subjects are present
...
BEGIN
    ...
    -- Determine results_status with updated logic
    ...
    ELSEIF v_candidates_with_four_subjects > 0 OR 
        ...
        -- Declared if:
        -- 1. At least some candidates have all 4 subjects, OR
        -- 2. At least 25% of candidates have marks, OR  
        -- 3. At least 14% of candidates have marks (special case for your school)
