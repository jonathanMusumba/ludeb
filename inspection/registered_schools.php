...
// Fetch registered schools (with candidates)
$schools_query = "
    SELECT 
        s.center_no,
        s.school_name,
...
<div class="welcome-header fade-in">
    ...
    <p><i class="fas fa-school me-2"></i>Schools with registered candidates for <?php echo htmlspecialchars($exam_year); ?></p>
</div>

<div class="table-card fade-in">
    <h5><i class="fas fa-check-circle me-2"></i>Registered Schools</h5>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><i class="fas fa-users me-1"></i>Number of Candidates</th>
...
// Render layout
renderLayout("Registered Schools - $exam_body", [
    'username' => $username,
    'exam_body' => $exam_body,
    'exam_year' => $exam_year,
    'content' => $content,
    'current_page' => 'registered_schools'
]);
?>