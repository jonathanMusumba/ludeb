...
// Fetch unregistered schools (no candidates)
$schools_query = "
    SELECT 
        s.center_no,
        s.school_name,
...
<div class="welcome-header fade-in">
    <h2>Unregistered Schools</h2>
    <p><i class="fas fa-school me-2"></i>Schools without registered candidates for <?php echo htmlspecialchars($exam_year); ?></p>
</div>

<div class="table-card fade-in">
    <h5><i class="fas fa-times-circle me-2"></i>Unregistered Schools</h5>
...
// Render layout
renderLayout("Unregistered Schools - $exam_body", [
    'username' => $username,
    'exam_body' => $exam_body,
    'exam_year' => $exam_year,
    'content' => $content,
    'current_page' => 'unregistered_schools'
]);
?>