...
function drawEnhancedResultSlip($pdf, $result, $school, $exam_body, $exam_year, $x, $y, $width, $height) {
    // Add decorative border around the slip
    ...
    // Bottom-left corner
    $pdf->Line($x, $y + $height - $corner_size, $x, $y + $height);
    $pdf->Line($x, $y + $height, $x + $corner_size, $y + $height);
    // Bottom-right corner
    $pdf->Line($x + $width - $corner_size, $y + $height, $x + $width, $y + $height);
    $pdf->Line($x + $width, $y + $height, $x + $width, $y + $height - $corner_size);
