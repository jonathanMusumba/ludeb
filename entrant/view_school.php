...
$conn->query("CALL log_action('View School Access', $user_id, 'Data Entrant accessed view school page')");
...
// Fetch school data
$stmt = $conn->prepare("SELECT s.center_no, s.school_name, s.subcounty_id, s.school_type_id, s.results_status, 
...
$stmt->bind_param("i", $school_id);
$stmt->execute();
$uploads_result = $stmt->get_result();
...
<head>
    ...
    <title>View School - Results Management System</title>
        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    <h1 class="page-title">
                        <i class="fas fa-school"></i>
                        View School: <?php echo htmlspecialchars($school['school_name']); ?>
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="schools.php">Schools List</a></li>
                ...
                <div class="card-enhanced">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="marks.php?school_id=<?php echo $school_id; ?>" class="btn-enhanced">
                                <i class="fas fa-plus"></i>
                                Enter Marks
                            </a>
                            <a href="see_marks.php?school_id=<?php echo $school_id; ?>" class="btn-enhanced btn-secondary-enhanced ms-2">
                                <i class="fas fa-eye"></i>
                                View Results
                            </a>
                        </div>
                            ...
                            <table class="table-enhanced">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-clock"></i> Uploaded Date</th>
                                    ...
                                    <?php if ($uploads_result->num_rows > 0): ?>
                                        <?php while ($upload = $uploads_result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="download_file.php?id=<?php echo $upload['id']; ?>" class="btn-enhanced btn-sm">
